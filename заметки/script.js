...
// ==== Создание новой заметки (возвращает DOM-элемент) ====
function createNoteElement() {
    ...
    // ---- Логика редактирования/сохранения (для этой конкретной заметки) ----
...
// Дополнительно: если клик по статистике при пустом поле — показываем 0
// updateStatistics сам обработает нулевое количество